        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            {currentUser ? (
              ...
              /* Direct Discord Button + Settings */
              <div className="flex items-center gap-1.5">
                ...
                {onOpenDiscordConfig && (
                  <button
                    id="header-discord-config-btn"
                    onClick={onOpenDiscordConfig}
                    title="Configurar Client ID de Discord"
                    className={`p-2 rounded-xl border transition-all cursor-pointer ${
                      isLight ? 'bg-gray-100 hover:bg-gray-200 border-gray-200 text-gray-600' : 'bg-[#22242b] hover:bg-[#2c2f38] border-[#363a45] text-gray-400 hover:text-white'
                    }`}
                  >
